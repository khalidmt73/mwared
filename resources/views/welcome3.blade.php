    ...
    <nav class="navbar navbar-expand-md navbar-light">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <div class="container-fluid">
                <div class="row">
                    <!-- sidebar -->
                    <div class="col-xl-3 col-lg-3 col-md-4 sidebar fixed-top text-right">
                    ...
                    <!-- top-nav -->
                    <div class="col-xl-9 col-lg-9 col-md-8 ml-auto fixed-top py-2 top-navbar">
                        <div class="row align-items-center">
                            <div class="col-md-2">

                                <a href="#" class="navbar-brand  d-block mx-auto 
